...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Page content-->
            <div class="container">
                <h1 class="mt-4 text-centertext-white"><strong> JURUS 2</strong></h1>
                ...
                <div class="row">
                    <div class="col"></div>
                    <div class="col-lg-5"><img src="../img/2.jpg" class="img-thumbnail bg-black" alt="#"></div>
                    <div class="col"></div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 img-thumbnail bg-black">
                            <div class="ratio ratio-16x9 ">
                                <iframe src="https://www.youtube.com/embed/3lnXKbbRyu4" title="Interval 1 2 and Jurus2"></iframe>
                            </div>
                        </div>
                        <div class="col"></div>
                    </div>
